...
export function loadState(slice: Slice) {
  ...
  return { $$type: "State" as const, owner: _owner, total: _total, nextId: _nextId }
}
...
export function storeTupleCertificationNFT$Data(source: CertificationNFT$Data) {
  ...
  builder.writeCell(
    source.admins.size > 0
      ? beginCell().storeDictDirect(source.admins, Dictionary.Keys.Address(), Dictionary.Values.Bool()).endCell()
      : null,
  )
  builder.writeCell(
    source.tokens.size > 0
      ? beginCell().storeDictDirect(source.tokens, Dictionary.Keys.BigInt(257), dictValueParserToken()).endCell()
      : null,
  )
  builder.writeNumber(source.total)
  builder.writeNumber(source.nextId)
...
async function CertificationNFT_init(owner: Address) {
  const __code = Cell.fromHex(
    "",
  )
  const builder = beginCell()
  builder.storeUint(0, 1)
  initCertificationNFT_init_args({ $$type: "CertificationNFT_init_args", owner })(builder)
...
const CertificationNFT_types: ABIType[] = [
  ...
  },
  {
    ...
    header: null,
    fields: [
      { name: "signature", type: { kind: "simple", type: "fixed-bytes", optional: false, format: 64 } },
      { name: "signedData", type: { kind: "simple", type: "slice", optional: false, format: "remainder" } },
    ],
  },
  {
    name: "StateInit",
  ...
  },
  {
    name: "AddAdmin",
    header: 3599441591,
    fields: [{ name: "newAdmin", type: { kind: "simple", type: "address", optional: false } }],
  },
  {
    name: "Mint",
    header: 2415581732,
    fields: [
      { name: "student", type: { kind: "simple", type: "address", optional: false } },
      { name: "metadata", type: { kind: "simple", type: "cell", optional: false } },
    ],
  },
  {
    name: "Token",
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "total", type: { kind: "simple", type: "int", optional: false, format: 257 } },
      { name: "nextId", type: { kind: "simple", type: "int", optional: false, format: 257 } },
    ],
  },
  {
    ...
    fields: [
      ...
      { name: "tokens", type: { kind: "dict", key: "int", value: "Token", valueFormat: "ref" } },
      { name: "total", type: { kind: "simple", type: "int", optional: false, format: 257 } },
      { name: "nextId", type: { kind: "simple", type: "int", optional: false, format: 257 } },
    ],
  },
...
const CertificationNFT_getters: ABIGetter[] = [
  { name: "state", methodId: 77589, arguments: [], returnType: { kind: "simple", type: "State", optional: false } },
  {
    name: "isAdmin",
    methodId: 122448,
    arguments: [{ name: "addr", type: { kind: "simple", type: "address", optional: false } }],
    returnType: { kind: "simple", type: "bool", optional: false },
  },
  {
    name: "token",
    methodId: 68497,
    arguments: [{ name: "id", type: { kind: "simple", type: "int", optional: false, format: 257 } }],
...
export class CertificationNFT implements Contract {
  public static readonly MAX_SUPPLY = 500n
  ...
  static async init(owner: Address) {
    return await CertificationNFT_init(owner)
  }

  static async fromInit(owner: Address) {
    const __gen_init = await CertificationNFT_init(owner)
